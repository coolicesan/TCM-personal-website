...
(function () {
  ...
  var TEXT = {
    ...
    '香港註冊中醫師 · 婦科 · 皮膚科 · 身心同治': 'Hong Kong Registered Chinese Medicine Practitioner · Women\'s Health · Dermatology · Mind-Body Care',
    '以中醫智慧，溫柔陪伴': 'Holistic care for women\'s health',
    '每個階段': 'at every stage of life',
    '女性每個階段': 'at every stage of life',
    '從青春期、備孕、孕期、產後到更年期，胡醫師以中醫理念為本、融合現代醫學知識與心理輔導專業，細心聆聽每位女性的需求，制定個人化治療方案，助你找回身心平衡。': 'CMP Kate Woo draws on Chinese medicine, blended with modern medical knowledge and counselling training, to support women from puberty through fertility, pregnancy, postpartum recovery and menopause. She listens closely to each woman\'s needs and designs a personalised treatment plan to help you restore balance in body and mind.',
    ...
    '體質是認識自己身體的起點，了解您的體質，找出適合您的飲食習慣與生活方式。': 'Your constitution is the starting point for understanding your body. Find out yours, and the diet and lifestyle habits that suit you.',
    '快速版（5 分鐘）及完整版（15 分鐘）可選': 'Choose the quick version (5 min) or the full version (15 min)',
    ...
    '依您目前的生命階段選擇評估項目，幫助您更全面了解目前的身體狀況。': 'Choose the assessment that matches your current life stage, to get a fuller picture of your health.',
    ...
    '香港浸會大學中醫藥及生物醫學學士（一級榮譽）': 'BSc in Chinese Medicine and Biomedical Science, HKBU (First Class Honours)',
    '香港浸會大學輔導學社會科學碩士': 'MSocSc in Counselling, HKBU',
    ...
    '中環診所': 'Central Clinic',
    '元澤堂，香港中環德輔道中19號': 'Heal & Glow, Unit 1103, 11/F, World-Wide House,',
    ...
    '就診需求': 'Main Concern',
    '請選擇': 'Please select',
    '婦科問題': 'Gynaecological concerns',
    'IVF/IUI輔助治療': 'IVF/IUI support',
    '安胎': 'Threatened miscarriage care',
    ...
    '輸入最近幾次月經第一天，算出平均週期、預測未來三次經期，並檢查週期是否在正常範圍。': 'Enter the first day of your recent periods to get your average cycle, the next three predicted, and a check on whether your cycles are within the normal range.',
    '最近幾次月經第一天': 'The first day of your recent periods',
    '最近一次': 'Most recent',
    '對上一次': 'The one before',
    '再對上一次': 'Two before',
    '更早一次': 'Three before',
    '只有最近一次是必填。填到三次以上，才看得出你的週期穩不穩定。': 'Only the most recent is required. Three or more is what reveals whether your cycles are steady.',
    '只在你填少於兩次經期日子時才會用到；有實際記錄時會改用你自己的數字。': 'Used only if you enter fewer than two dates. With real records, your own numbers are used instead.',
    '預測下次經期': 'Predict my next period',
    '下次月經': 'Next period',
    '一個週期的圓環圖，標出經期與今日的位置': 'A ring chart of one cycle marking the bleeding days and where today falls',
    '平均週期': 'Average cycle',
    '未來三次月經': 'Your next three periods',
    '按你的平均週期推算。實際日子會隨作息、壓力與身體狀況浮動。': 'Projected from your average cycle. Real dates move with sleep, stress and health.',
    '中醫怎麼看這種週期': 'How Chinese medicine reads a cycle like this',
    '週期長度指由這次月經第一天，數到下次月經第一天。一般 21 至 35 天都屬正常，每月相差 7 至 9 天以內亦屬常見；青春期與更年期前後的波動會較大。': 'Cycle length is counted from the first day of one period to the first day of the next. Anywhere from 21 to 35 days is normal, and a month-to-month difference of seven to nine days is common. Variation is wider in adolescence and around menopause.',
    '若連續三個月沒有月經、週期長期短於 21 天或長於 35 天、經量突然大幅改變，或出現非經期出血，請安排檢查。本工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。撰文及覆核：胡佩珊中醫師（香港中醫藥管理委員會註冊中醫師，註冊編號：008823）。': 'Arrange an assessment if you go three months without a period, if your cycles are persistently under 21 or over 35 days, if the flow changes sharply, or if you bleed between periods. This tool is for health education only. It is not medical advice and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Written and reviewed by CMP Kate Woo (Registered Chinese Medicine Practitioner, CMCHK 008823).',
    '輸入分娩日期與分娩方式，排出惡露、坐月、產後檢查與開始運動的日期。': 'Enter your delivery date and type of birth to get the dates for lochia, confinement, the postnatal check and starting exercise.',
    '分娩日期': 'Date of birth',
    '寶寶出生那天。': 'The day your baby was born.',
    '分娩方式': 'Type of birth',
    '順產': 'Vaginal',
    '剖腹產': 'Caesarean',
    '餵哺方式': 'Feeding',
    '母乳為主': 'Mainly breastfeeding',
    '混合餵哺': 'Mixed feeding',
    '沒有餵哺': 'Not breastfeeding',
    '影響乳房護理與退奶的安排。': 'This changes the breast care and lactation entries.',
    '排出時間表': 'Build my timeline',
    '頭 7 天': 'First 7 days',
    '惡露最多': 'Lochia at its heaviest',
    '坐月': 'Confinement',
    '第 8–30 天': 'Days 8–30',
    '產褥期末': 'End of puerperium',
    '第 31–42 天': 'Days 31–42',
    '恢復期': 'Recovery',
    '第 43 天起': 'From day 43',
    '產後 100 天': '100 days after birth',
    '時間表': 'Timeline',
    '按你的分娩日期排出。每個人的恢復速度不同，日期是常見的參考範圍，不是硬性規定。': 'Counted from the day you gave birth. Everyone recovers at their own pace — these are common ranges, not rules.',
    '出現以下情況，不要等下次覆診': 'Do not wait for your next appointment if any of this happens',
    '發燒 38°C 或以上，或畏寒發抖': 'A fever of 38°C or above, or shivering and chills',
    '惡露突然大量增加、出現大血塊，或一小時內濕透一片衛生巾': 'Lochia suddenly much heavier, large clots, or soaking a pad within an hour',
    '惡露有異味，或已轉淡後又變回鮮紅': 'Lochia with an odour, or turning bright red again after it had faded',
    '傷口紅腫、劇痛、有分泌物或裂開': 'A wound that is red, severely painful, discharging or opening',
    '單側小腿腫痛發熱，或突然氣促、胸痛': 'One calf swollen, painful and warm, or sudden breathlessness or chest pain',
    '持續劇烈頭痛、視力模糊，或血壓偏高': 'Persistent severe headache, blurred vision or raised blood pressure',
    '情緒持續低落、無法照顧自己或寶寶，或出現傷害自己或寶寶的念頭': 'Persistent low mood, being unable to care for yourself or your baby, or thoughts of harming either of you',
    '香港的產後檢查一般安排在產後 6 週；剖腹產的傷口覆診會較早。母嬰健康院同期會安排寶寶的檢查與疫苗。': 'The postnatal check in Hong Kong is usually at six weeks; a caesarean wound is reviewed earlier. Maternal and Child Health Centres schedule your baby\'s checks and vaccinations over the same period.',
    '生化湯與其他產後方劑必須由註冊中醫師按你的惡露、體質與傷口情況決定是否適用及服用時間，本工具只列出一般的時間範圍，不構成處方。本工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。撰文及覆核：胡佩珊中醫師（香港中醫藥管理委員會註冊中醫師，註冊編號：008823）。': 'Whether Sheng Hua Tang or any other postpartum formula suits you, and when to take it, must be decided by a registered Chinese medicine practitioner based on your lochia, constitution and wound. This tool gives general timing only and is not a prescription. It is for health education only, is not medical advice, and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Written and reviewed by CMP Kate Woo (Registered Chinese Medicine Practitioner, CMCHK 008823).',

    '孕期體重管理': 'Pregnancy weight',
    '輸入孕前身高體重與現時孕週，算出你的建議增重範圍，以及往後每週應該增多少。': 'Enter your pre-pregnancy height and weight and your current week to get your recommended range, and how much to gain each week from here.',
    '懷孕前的身高與體重': 'Your height and weight before pregnancy',
    '用懷孕前的體重，不是現在的。建議範圍完全由這個數字決定。': 'Use your pre-pregnancy weight, not today\'s. The whole recommended range is derived from it.',
    '現時體重': 'Current weight',
    '現時孕週': 'Current week',
    '不確定的話，先用': 'Not sure? Start with the ',
    '胎數': 'Babies',
    '單胎': 'One',
    '雙胎': 'Twins',
    '看我的範圍': 'Show my range',
    '到目前為止': 'So far',
    '建議增重範圍與你的位置｜縱軸為累積增重，橫軸為孕週': 'The recommended range and where you sit — cumulative gain against gestational week',
    '由孕前 BMI 推算的建議累積增重範圍，橫軸為孕週，縱軸為增重公斤數，並標出你目前的位置。詳細數字見下方列表。': 'The recommended cumulative weight gain derived from your pre-pregnancy BMI, plotted against gestational week in kilograms, with your current position marked. The figures are listed below the chart.',
    '往後的建議': 'From here on',
    '第二、三孕期的增重是比較平均的，所以看每週的幅度比看總數實際。': 'Gain is fairly even through the second and third trimesters, so the weekly figure is more useful than the total.',
    '體重變化出現以下情況，要立即求醫': 'Seek care immediately if your weight does any of this',
    '一星期突然增加超過 1 公斤，同時有明顯水腫、劇烈頭痛或視力模糊——可能是子癇前症': 'More than 1 kg in a week together with marked swelling, severe headache or blurred vision — this can be pre-eclampsia',
    '孕吐嚴重到體重比孕前下跌超過 5%，或無法進食飲水': 'Nausea severe enough to drop you more than 5% below your pre-pregnancy weight, or leaving you unable to eat or drink',
    '第二、三孕期持續沒有增重，甚至下跌': 'No gain at all through the second or third trimester, or a loss',
    '建議範圍採用美國國家醫學院（IOM，2009）按孕前 BMI 分組的指引，這也是香港產科普遍採用的參考。曲線的畫法是：第一孕期增 0.5 至 2 公斤，其後平均增至 40 週的總範圍上下限；實際體重每星期上落一公斤以內很常見，看趨勢比看單次磅數有意義。': 'The ranges follow the Institute of Medicine (IOM, 2009) guidelines by pre-pregnancy BMI, which Hong Kong obstetric practice generally uses. The curve is drawn as 0.5 to 2 kg through the first trimester, then evenly to the total range at 40 weeks. A kilo either way from week to week is common — the trend matters more than any single reading.',
    '雙胎的範圍屬 IOM 的暫定建議，孕前過輕的雙胎孕婦則未有足夠數據。體重只是產檢其中一項指標，血壓、血糖、胎兒大小與水腫同樣重要，實際以你的產科醫生為準。本工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。撰文及覆核：胡佩珊中醫師（香港中醫藥管理委員會註冊中醫師，註冊編號：008823）。': 'The twin ranges are provisional IOM guidance, and there is no adequate data for twins with a pre-pregnancy underweight BMI. Weight is only one antenatal measure — blood pressure, glucose, fetal growth and swelling matter just as much, and your obstetrician has the final say. This tool is for health education only. It is not medical advice and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Written and reviewed by CMP Kate Woo (Registered Chinese Medicine Practitioner, CMCHK 008823).',
    '身高 cm': 'Height cm',
    '孕前體重 kg': 'Pre-pregnancy kg',
    '基礎體溫記錄圖': 'Basal body temperature chart',
    '逐日記錄體溫，看曲線是否雙相、高溫期是否足夠。': 'Record your temperature each day to see whether the curve is biphasic and the luteal phase long enough.',
    '由分娩日期、順產或剖腹、有否餵哺，排出分階段的恢復時間表：生化湯的適用窗口、惡露觀察、產後檢查與開始運動的時機。': 'From your delivery date, birth type and whether you are feeding, it lays out the stages of recovery: when Sheng Hua Tang applies, what to watch in the lochia, the postnatal check, and when exercise can start.',
    '由孕前 BMI 算出屬於你的建議增重範圍，看現在落在區間的哪裡，以及往後每週應該增多少。支援單胎與雙胎。': 'Works out your own recommended gain from your pre-pregnancy BMI, shows where you sit in it, and how much to gain each week from here. Singletons and twins.',
    '體重': 'Weight',

    /* ── 實用小工具（tools/）──
       工具頁裡由 JS 生成、夾著數字的句子不在這裡，
       而是寫在各工具自己的 T.t({zh,en}) 對照表中。 */
    '實用小工具': 'Tools',
    '這裡有五個常用的計算工具：排卵期、預產期、經期預測、孕期體重與產後時間表。輸入你手上已有的日期或數字，即時有答案。': 'Five calculators for the dates and numbers that come up most: ovulation, due date, period prediction, pregnancy weight and postpartum recovery. Enter what you already have and you get an answer straight away.',
    '所有計算在你的裝置上完成，不會上傳或儲存': 'Everything is calculated on your device. Nothing is uploaded or stored.',
    '月經與備孕': 'Periods and fertility',
    '週期、排卵與經期記錄': 'Cycles, ovulation and period records',
    '排卵期與易孕期': 'Ovulation and fertile window',
    '算出的是一段易孕期，不是單一個排卵日。週期起伏太大時，會說明計算結果為甚麼不可靠。': 'Gives you a fertile window rather than a single day, and explains why the result is unreliable when your cycles vary a lot.',
    '月經': 'Menstrual health',
    '開始計算': 'Open the tool',
    '經期預測與週期檢查': 'Period prediction and cycle check',
    '輸入最近幾次經期首日，看未來三次的預測；同時檢查週期長度與每月變化，是否仍在 21 至 35 天的正常範圍。': 'Enter the first day of your recent periods to see the next three predicted, and check whether your cycle length and its month-to-month variation still sit inside the normal 21 to 35 day range.',
    '準備中': 'In progress',
    '懷孕與產後': 'Pregnancy and postpartum',
    '由知道懷孕到產後恢復': 'From a positive test to recovery after birth',
    '預產期計算器': 'Due date calculator',
    '末次經期、受孕日、IVF 植入日或超聲波報告，四種算法都支援。除了預產期，也列出香港產檢每一項的時間。': 'Works from your last period, the date of conception, an IVF transfer or a scan report. Alongside the due date it lays out when each Hong Kong antenatal check falls.',
    '孕期': 'Pregnancy',
    '產後 100 天調理時間表': 'The first 100 days after birth',
    '由分娩日期、順產或剖腹、有否餵哺，排出分階段的恢復時間表：生化湯的適用窗口、惡露觀察、束腹與開始運動的時機。': 'From your delivery date, birth type and whether you are feeding, it lays out the stages of recovery: when Sheng Hua Tang applies, what to watch in the lochia, and when to start binding and exercise.',
    '孕期體重管理與基礎體溫記錄圖也在名單上，會按同一個版型陸續加入。': 'A pregnancy weight tracker and a basal body temperature chart are on the list, and will follow the same layout.',
    '想知道得更多，可以做問卷': 'For more than a date, try a questionnaire',
    '計算工具只能給你日期與數字。想知道自己的體質，或身體目前的整體狀況，問卷會說得更清楚。': 'A calculator can only give you dates and numbers. To find out your constitution, or how your health is doing overall, a questionnaire says more.',
    '本網站所有內容與線上工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。若您出現急性或嚴重症狀，請立即求醫。': 'Everything on this site, including the online tools, is for health education only. It is not medical advice and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Seek care immediately for acute or severe symptoms.',
    '© 2026 胡佩珊中醫師 · 香港中醫藥管理委員會註冊中醫師（008823） ·': '© 2026 CMP Kate Woo · Registered Chinese Medicine Practitioner, CMCHK 008823 ·',
    '私隱政策': 'Privacy Policy',
    '麵包屑': 'Breadcrumb',
    '輸入末次經期、受孕日、IVF 植入日或超聲波報告，算出預產期與現時孕週，並列出香港產檢每一項的日期。': 'Enter your last period, a conception date, an IVF transfer or a scan report to get your due date and current week, with the date of every Hong Kong antenatal check.',
    '你手上有哪個日期？': 'Which date do you have?',
    '末次經期': 'Last period',
    '受孕日': 'Conception',
    'IVF 植入': 'IVF transfer',
    '超聲波': 'Ultrasound',
    '末次月經第一天': 'First day of your last period',
    '是出血第一天，不是結束那天。': 'The first day of bleeding, not the day it ended.',
    '平均週期長度': 'Average cycle length',
    '由這次經期第一天，數到下次經期第一天的天數。不確定就留 28。': 'Days from the first day of one period to the first day of the next. Leave it at 28 if you are unsure.',
    '受孕日或排卵日': 'Date of conception or ovulation',
    '排卵試紙轉強陽的翌日，或體溫升高那天。': 'The day after an LH strip turns strongly positive, or the day your temperature rose.',
    '胚胎植入日': 'Embryo transfer date',
    '植入時的胚胎日數': 'Age of the embryo at transfer',
    '第 5 天（囊胚 / Day 5）': 'Day 5 (blastocyst)',
    '第 3 天（卵裂期 / Day 3）': 'Day 3 (cleavage stage)',
    '第 6 天（Day 6 囊胚）': 'Day 6 (blastocyst)',
    '寫在你的植入報告上，不確定就問診所。': 'It is on your transfer report — ask your clinic if you are unsure.',
    '超聲波檢查日期': 'Date of the scan',
    '報告上的孕週': 'Gestational age on the report',
    '例如報告寫 GA 12w3d，就填 12 和 3。': 'If the report says GA 12w3d, enter 12 and 3.',
    '週數': 'Weeks',
    '天數': 'Days',
    '計算預產期': 'Calculate due date',
    '清除': 'Clear',
    '預產期': 'Due date',
    '今日': 'Today',
    '第一孕期': 'First trimester',
    '0–13 週': '0–13 weeks',
    '第二孕期': 'Second trimester',
    '14–27 週': '14–27 weeks',
    '第三孕期': 'Third trimester',
    '28 週起': 'From 28 weeks',
    '預產期（40 週）': 'Due date (40 weeks)',
    '香港產檢時間表': 'Hong Kong antenatal schedule',
    '按你的預產期排出。公立與私家醫院安排略有差異，實際以你的產科診所為準。': 'Placed against your due date. Public and private hospitals differ slightly; your own clinic has the final say.',
    '這個階段的中醫調理': 'Chinese medicine at this stage',
    '預產期是一個估算，只有約 4% 的寶寶在當天出生，37 至 42 週之間出生都屬正常範圍。若超聲波推算與經期推算相差超過 5 至 7 天，產科一般會以較早期的超聲波為準——請以你的產科醫生的判斷為準。': 'A due date is an estimate: only about 4% of babies arrive on the day, and any birth between 37 and 42 weeks is within the normal range. If a scan and your dates differ by more than five to seven days, obstetric practice is to go with the earlier scan — follow your own obstetrician\'s judgement.',
    '本工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。撰文及覆核：胡佩珊中醫師（香港中醫藥管理委員會註冊中醫師，註冊編號：008823）。': 'This tool is for health education only. It is not medical advice and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Written and reviewed by CMP Kate Woo (Registered Chinese Medicine Practitioner, CMCHK 008823).',
    '孕期及產後調理': 'Pregnancy and postpartum care',
    '排卵期計算器': 'Ovulation calculator',
    '輸入月經第一天與週期長度，算出你的易孕期。週期不規律時，會說明結果為甚麼不可靠。': 'Enter the first day of your period and your cycle length to get your fertile window. If your cycles are irregular, it explains why the result cannot be relied on.',
    '最近一次月經第一天': 'First day of your most recent period',
    '由這次經期第一天，數到下次經期第一天的天數。': 'Days from the first day of one period to the first day of the next.',
    '最近半年的週期長度範圍': 'Your cycle range over the past six months',
    '（可留空）': '(optional)',
    '填了才能判斷你的週期夠不夠穩定——這一步比算出日期更重要。': 'This is what shows whether your cycles are steady enough — it matters more than the date itself.',
    '經期長度': 'Period length',
    '行經一般 3 至 7 天。': 'Bleeding usually lasts 3 to 7 days.',
    '最短幾天': 'Shortest',
    '最長幾天': 'Longest',
    '計算易孕期': 'Calculate fertile window',
    '易孕期': 'Fertile window',
    '一個週期的圓環圖，標出經期、易孕期與排卵日': 'A ring chart of one cycle marking the period, the fertile window and ovulation day',
    '排卵日': 'Ovulation day',
    '之後三個週期': 'The next three cycles',
    '按你填的平均週期推算。實際日子會隨每個月的狀況浮動。': 'Projected from the average cycle you entered. Real dates move with each month.',
    '想算得更準，可以做這些': 'How to get closer than a calendar',
    '怎樣確認自己真的有排卵？': 'How do you confirm that you actually ovulate?',
    '排卵試紙、基礎體溫與超聲波的分別': 'LH strips, basal body temperature and ultrasound compared',
    '排卵期怎樣計？易孕期是哪幾日': 'How to work out ovulation and the fertile days',
    '為甚麼計算機對週期不規律的人不準確': 'Why calculators fail on irregular cycles',
    '月經週期是怎麼運作的': 'How the menstrual cycle works',
    '從卵泡期到黃體期，身體在做甚麼': 'What the body is doing from follicular to luteal phase',
    '備孕及不孕中醫調理': 'Fertility support in Chinese medicine',
    '甚麼情況下應該開始檢查': 'When it is time to start investigating',
    '這個工具不能用作避孕。': 'This tool must not be used for contraception.',
    '日曆推算法的典型使用失敗率約為 24%，精子在體內可存活最多 5 天，排卵時間亦會隨壓力、疾病與作息改變。': 'Calendar methods have a typical-use failure rate of about 24%. Sperm survive up to five days, and ovulation shifts with stress, illness and sleep.',
    '若你的週期長期短於 21 天或長於 35 天、每月相差超過 7 至 9 天，或曾停經三個月以上，計算法不適用，建議先安排檢查。本工具僅供健康教育參考，不構成醫療建議，亦不能取代註冊醫師或中醫師的診斷與治療。撰文及覆核：胡佩珊中醫師（香港中醫藥管理委員會註冊中醫師，註冊編號：008823）。': 'If your cycles are persistently under 21 days or over 35, vary by more than seven to nine days, or you have gone three months or more without a period, calendar counting does not apply and an assessment comes first. This tool is for health education only. It is not medical advice and does not replace diagnosis or treatment by a registered doctor or Chinese medicine practitioner. Written and reviewed by CMP Kate Woo (Registered Chinese Medicine Practitioner, CMCHK 008823).',
    '備孕及不孕調理': 'Fertility support'
  };
