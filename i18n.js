...
(function () {
  ...
  var TEXT = {
    ...
    '經期・週期問題': 'Menstrual symptoms and cycle changes',
    '月經不規律': 'Irregular periods',
    '經前症候群': 'PMS',
    '痛經調理': 'Period pain support',
    '婦科疾病': 'Gynaecological Conditions',
    '肌瘤・息肉・異位症': 'Fibroids, polyps, endometriosis',
    '子宮內膜異位症': 'Endometriosis',
    '多囊卵巢症': 'PCOS',
    '子宮肌瘤/息肉': 'Fibroids and polyps',
    ...
    '中醫辨證調理代謝，結合針灸與中藥，健康持續管理體重。': 'Support for metabolism, appetite, bloating and water retention, with realistic habits that fit daily life.',
    '脫髮調理': 'Hair Loss Support',
    '補腎養血、疏通頭皮氣血，從根本改善脫髮問題。': 'Care for hair shedding linked with postpartum change, stress, sleep, nutrition or constitutional imbalance.',
    '乳腺針灸': 'Breast Acupuncture',
    '疏肝理氣、活血通絡，改善乳腺增生與乳房脹痛。': 'Support for cyclical breast tenderness, benign breast discomfort and lactation-related stagnation when appropriate.',
