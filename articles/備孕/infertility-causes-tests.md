...
**關於 AMH 的重要提醒**：AMH 反映卵子的數量，不反映質素，也**不能預測自然受孕的機會**。數值偏低不等於不能懷孕【內部連結：AMH 低是否無法懷孕】。
...
面對久未懷孕，最有效的第一步不是進補，而是**弄清楚原因，而且雙方一起檢查**。檢查本身並不複雜，但它決定了之後所有決定是否用得其所。
...
【待補充：內部連結——多囊卵巢 PCOS／PMOS、AMH 與卵巢功能早衰、IVF 流程、中醫怎樣配合 IVF、基礎體溫點量、備孕支柱頁】
【待核對事項】
